...
class BaseModel:
    '''
    Base class for all models. It implements the draw function for all objects.
    '''
    ...
    def bind_shader(self, shader):
        '''
        If a new shader is bound, it is re-linked to ensure attributes are correctly linked.  
        '''
...
class DrawModelFromMesh(BaseModel):
    '''
    Base class for all models. It can be used to create new models.
    '''
