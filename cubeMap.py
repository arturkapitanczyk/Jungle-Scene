...
class CubeMap(Texture):
    ...
    def __init__(self, name=None, files=None, wrap=GL_CLAMP_TO_EDGE, sample=GL_LINEAR, format=GL_RGBA, type=GL_UNSIGNED_BYTE):
        ...
        self.files = {
            GL_TEXTURE_CUBE_MAP_NEGATIVE_X: 'junglewall.jpg',
            GL_TEXTURE_CUBE_MAP_POSITIVE_Z: 'junglewall.jpg',
            GL_TEXTURE_CUBE_MAP_POSITIVE_X: 'junglewall.jpg',
            GL_TEXTURE_CUBE_MAP_NEGATIVE_Z: 'junglewall.jpg',
            GL_TEXTURE_CUBE_MAP_POSITIVE_Y: 'junglewall.jpg',
            GL_TEXTURE_CUBE_MAP_NEGATIVE_Y: 'junglewall.jpg',
        }
    ...
    def set(self, name, files=None):
        ...
        for (key, value) in self.files.items():
            ...
            # the python image objects is converted to a plain byte array in order for it to be passed to OpenGL
